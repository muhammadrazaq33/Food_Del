...
const Footer = () => {
  return (
    <div className="mt-[100px] text-[#d9d9d9] bg-[#323232] flex flex-col items-center py-[20px] px-[8vw] pt-[80px] gap-[20px]">
      <div className="footer_content">
        ...
        <div className="flex flex-col items-start gap-[20px]">
          ...
          <ul>
            ...
            <li className="mb-[10px] cursor-pointer">muhammadrazaq5913483@gmail.com</li>
          </ul>
        </div>
      </div>
