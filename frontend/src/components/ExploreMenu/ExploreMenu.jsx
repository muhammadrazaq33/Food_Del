...
const ExploreMenu = ({category,setCategory}) => {
  return (
    <div className='flex flex-col gap-[20px] mb-8'>
          <h1 className='text-[#262626] font-semibold text-[1.8rem]'>Explore our menu</h1>
          <p className='text-[#808080] md:max-w-[60%] max-w-[100%] md:text-[17px] sm:text-[16px] text-[13px] '>Choose from a diverse menu featuring a delectable array of dishes. Our mission is to satisfy your cravings and elevate your dining experience, one delicious meal at a time.</p>
